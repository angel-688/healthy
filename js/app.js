(() => {
    ...
    (() => {
        ...
        console.log(document.querySelectorAll("[data-simplebar]"));
        ...
        if (iconMenu) iconMenu.addEventListener("click", (function(e) {
            mainDocument.classList.toggle("menu-open");
            mainDocument.classList.toggle("lock");
        }));
        ...
        if (menuItems.length > 0) menuItems.forEach((menuItem => {
            menuItem.addEventListener("click", (function(e) {
                ...
                if (menuTarget.dataset.goto && document.querySelector(menuTarget.dataset.goto)) {
                    const dataValue = document.querySelector(menuTarget.dataset.goto);
                    const blockPosition = dataValue.getBoundingClientRect().top + scrollY - document.querySelector(".header").offsetHeight;
                    if (mainDocument.classList.contains("menu-open")) {
                        mainDocument.classList.remove("menu-open");
                        mainDocument.classList.remove("lock");
                    }
                    window.scrollTo({
                        top: blockPosition,
                        behavior: "smooth"
        ...
        function initRatings() {
            ...
            function initRating(rating) {
                ...
                setRatingWidth();
                if (rating.classList.contains("rating_set")) setRatingValue(rating);
            }
            ...
            function setRatingWidth(index = ratingValue.innerHTML) {
                const ratingVar = index / .05;
                ratingActive.style.width = `${ratingVar}%`;
            }
            function setRatingValue(rating) {
                ...
                for (let index = 0; index < ratingItems.length; index++) {
                    ...
                    ratingItem.addEventListener("mouseenter", (function(e) {
                        initRatingVars(rating);
                        setRatingWidth(ratingItem.value);
                    }));
